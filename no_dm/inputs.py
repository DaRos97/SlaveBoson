...
Ny = 13
mp_cpu = 1#6
list_ans = ['3x3_1','q0_1','cb1','cb2','oct']#,'3x3_2','3x3_3','3x3_4','q0_1','q0_2','q0_3','q0_4','cb1','cb2','oct']
...
Pi = {  '3x3_1':{'A1':0.51, 'A3':0.433, 'B1':0.17, 'B2': 0.35, 'B3': 0.25, 'phiA3': np.pi},
        ...
        'cb2':{'A1':0.25, 'A2':0.433, 'A3':0.3, 'B1':0.3, 'B2': 0.25, 'phiB1':np.pi, 'phiA2':np.pi},
        'oct':{'A1':0.35, 'A2':0.35, 'B1':0.35, 'B2': 0.35, 'B3':0.35 ,'phiB1':np.pi, 'phiB2':np.pi}
        }
lAns = header.keys()
bounds = {}
num_phi = {}
