...
Ny = 13
mp_cpu = 32
list_ans = ['3x3_1','cb1','q0_1']
DirName = '/home/users/r/rossid/Data/yesDM/'
#DirName = '../Data/test/'
DataDir = DirName + 'Data_'+str(Nx)+'-'+str(Ny)+'_P/'
...
Pi = {  '3x3_1':{'A1':0.51, 'A3':0.17, 'B1':0.17, 'B2': 0.41, 'B3': -0.12, 'phiB1': np.pi, 'phiB2': 0, 'phiA3': np.pi},
        ...
        'q0_2':{'A1':0.51, 'A2':0.13, 'B1':0.18, 'B2': 0.18, 'B3': 0.3, 'phiA1': 0, 'phiB1': np.pi, 'phiA2': np.pi, 'phiB2': np.pi, 'phiB3': 0},
...
for ans in lAns:
    ...
    if ans == '3x3_1':
        ...
        bounds[ans]['phiA2'] = (np.pi-0.3,np.pi+0.3)
        bounds[ans]['phiB2'] = (np.pi-0.2,np.pi+0.2)
        num_phi[ans] = 4
L_bounds = (0.3,2)
shame2 = 5
