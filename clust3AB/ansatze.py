...
def Nk(P,L,args):
    ...
    N[0,4] = J1*b1_*ke1_  + J2*kf1*b2pi
    N[0,5] = J1*b1*ke2    + J2*kf2*b2i_
    N[1,2] = J1*(b1_*ke3_ + b1p_*ke3)
    N[1,3] = J1*b1*ke1    + J2*kf1_*b2p_
    N[1,5] = J2*(b2*kf3_ + b2p*kf3)
    N[2,3] = J1*b1_*ke2_  + J2*kf2_*b2
    ...
    N[m+0,m+4] = J1*b1*ke1_  + J2*kf1*b2pi_
    N[m+0,m+5] = J1*b1_*ke2    + J2*kf2*b2i
    N[m+1,m+2] = J1*(b1*ke3_ + b1p*ke3)
    N[m+1,m+3] = J1*b1_*ke1    + J2*kf1_*b2p
    N[m+1,m+5] = J2*(b2_*kf3_ + b2p_*kf3)
    N[m+2,m+3] = J1*b1*ke2_  + J2*kf2_*b2_
    ...
    N[m+0,m+0] = J3*kg3_*b3i
    N[m+3,m+3] = J3*kg3_*b3
    ...
    N[0,m+4] = - J1*a1*ke1_   +J2*a2pi*kf1
    N[0,m+5] =   J1*a1*ke2    -J2*a2i*kf2
    N[1,m+2] = - J1*(a1*ke3_  +a1p*ke3)
    N[1,m+3] =   J1*a1*ke1    -J2*a2p*kf1_
    N[1,m+5] =   J2*(a2*kf3_  +a2p*kf3)
    N[2,m+3] = - J1*a1*ke2_   +J2*a2*kf2_
    ...
    N[4,m]   =   J1*a1*ke1    -J2*a2pi*kf1_
    N[5,m]   = - J1*a1*ke2_   +J2*a2i*kf2_
    N[2,m+1] =   J1*(a1*ke3   +a1p*ke3_)
    N[3,m+1] = - J1*a1*ke1_   +J2*a2p*kf1
    N[5,m+1] = - J2*(a2*kf3   +a2p*kf3_)
    N[3,m+2] =   J1*a1*ke2    -J2*a2*kf2
