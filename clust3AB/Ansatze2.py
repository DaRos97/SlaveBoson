...
def Nk(P,L,args):
    ...
    #
    N[0,1] = J1*b1p_ *ke1  *t1               + J2*b2   *kf1_
    N[0,2] = J1*b1p  *ke2_ *t1_              + J2*b2p_ *kf2_
    N[0,4] = J1*b1_  *ke1_ *t1               + J2*b2pi *kf1
    N[0,5] = J1*b1   *ke2  *t1_              + J2*b2i_ *kf2
    N[1,2] = J1*(b1_ *ke3_ *t1  + b1p_*ke3*t1)
    N[1,3] = J1*b1   *ke1  *t1_              + J2*b2p_ *kf1_
    N[1,5] =                                   J2*(b2  *kf3_ + b2p *kf3)
    N[2,3] = J1*b1_  *ke2_ *t1               + J2*b2   *kf2_
    N[2,4] =                                   J2*(b2p_*kf3_ + b2i_*kf3)
    N[3,4] = J1*b1pi_*ke1  *t1               + J2*b2   *kf1_
    N[3,5] = J1*b1p  *ke2_ *t1_              + J2*b2pi_*kf2_
    N[4,5] = J1*(b1_ *ke3_ *t1  + b1pi_*ke3*t1)
    ...
    ####other half square
    N[m+0,m+1] = J1*b1p  *ke1  *t1            + J2*b2_  *kf1_
    N[m+0,m+2] = J1*b1p_ *ke2_ *t1_           + J2*b2p  *kf2_
    N[m+0,m+4] = J1*b1   *ke1_ *t1            + J2*b2pi_*kf1
    N[m+0,m+5] = J1*b1_  *ke2  *t1_           + J2*b2i  *kf2
    N[m+1,m+2] = J1*(b1  *ke3_ *t1  + b1p*ke3*t1)
    ...
    N[m+3,m+4] = J1*b1pi *ke1  *t1            + J2*b2_  *kf1_
    N[m+3,m+5] = J1*b1p_ *ke2_ *t1_           + J2*b2pi *kf2_
    N[m+4,m+5] = J1*(b1  *ke3_ *t1  + b1pi*ke3*t1)
