...
#derivative
s_b = 0.01 #bound on values given by smaller grids (only when ReferenceDir is given)
der_par = 1e-6
der_phi = 1e-5
...
Pi = {  '3x3_1':{'A1':0.523, 'A3':0.317, 'B1':0.212, 'B2': 0.393, 'B3': 0.183, 'phiB1': np.pi, 'phiB2': 0, 'phiA3': 0},
