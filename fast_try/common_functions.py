...
def Sigma(P,*Args):
    ...
    print(Fore.YELLOW+"First computation:: ",t()-Tti,Fore.RESET)
    exit()
    ...
    for i in range(len(P)): #for each parameter
        ...
        if sign == hess:
            ...
            try:
                ...
                r2 = 100
            temp.append(r2)
        print(Fore.CYAN+"Parameter ",pars[i]," : ",t()-Tti,Fore.RESET)
    res = np.array(temp).sum()
    print(Fore.GREEN+"Result of Sigma: ",res," and time: ",t()-Ti,Fore.RESET)
    exit()
    return res
####
...
def sumEigs(P,L,args):
    ...
    print(Fore.YELLOW+"Generation of N for all Ks takes: ",t()-T__,Fore.RESET)
    ...
    for i in range(inp.Nx):
        for j in range(inp.Ny):
            ...
            try:
                ...
                print(Fore.RED+"Not good L: ",L,Fore.RESET)
            ...
            res[:,i,j] = LA.eigvalsh(temp,check_finite = False)[inp.m:]
    print("Total took:",t()-T__)
    T__ = t()
    r2 = 0
    for i in range(inp.m):
    ...
    print(Fore.YELLOW+"Interpolationa nd integration takes: ",t()-T__,Fore.RESET)
    exit()
    return r2, gap
    if 0:
        #plot
...
def totE(P,args):
    ...
    print("Maximization of L took: ",t()-Ttti," with ",res.nit," iterations")
    L = res.x
    minE = -res.fun
...
def totEl(P,L,args):
    ...
    res += eigEn[0]
    print(Fore.CYAN+"In Total: ",t()-T_,Fore.RESET)
    return res, eigEn
